...
const tools = {
  ...
  pexels_photo_search: pexelsPhotoSearchTool,
  pexels_video_search: pexelsVideoSearchTool,
  lottie_search: lottieSearchTool,
  lottie_download: lottieDownloadTool,
